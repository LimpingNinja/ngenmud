...
PyObject *PyChar_getinv(PyChar *self, PyObject *args) {
    ...
    ITERATE_LIST(obj, inv_i)PyList_Append(list, objGetPyFormBorrowed(obj));
...
PyObject *PyChar_all_chars(PyObject *self) {
    ...
    CHAR_DATA *ch = NULL;
    ITERATE_LIST(ch, ch_i)PyList_Append(list, charGetPyFormBorrowed(ch));
...
PyMODINIT_FUNC init_PyChar(void) {
    ...
    deleteListWith(pychar_getsetters, free);
    pychar_getsetters = NULL;
    deleteListWith(pychar_methods, free);
    pychar_methods = NULL;
