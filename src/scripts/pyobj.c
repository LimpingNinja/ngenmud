...
PyObject *PyObj_getcontents(PyObj *self, PyObject *args) {
    ...
    ITERATE_LIST(cont, cont_i)PyList_Append(list, objGetPyFormBorrowed(cont));
...
init_PyObj(void) {
    ...
    deleteListWith(pyobj_getsetters, free);
    pyobj_getsetters = NULL;
    deleteListWith(pyobj_methods, free);
    pyobj_methods = NULL;
